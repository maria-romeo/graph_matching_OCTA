...
if __name__ == "__main__":
    ...
    source_folder = r'/Users/maria/Documents/GitHub/TFM/OCTA_time_series/GRAPH_matching/data/soul_longitudinal/'  # Cambia esto por la ruta a tu carpeta de imágenes
